            ...
            </Avatar>
            {
              hovered && (
                ...
                onClick={image ? handleDeleteImage : handleFileInputClick}>
                  {
                    image ? <FaTrash className="text-white text-3xl cursor-pointer"/> : <FaPlus className="text-white text-3xl cursor-pointer"></FaPlus>
                  }
                </div>
          ...
          <div className="w-full flex gap-5">
            {
              ...
              <div 
                 ...
                 ${selectedColor === index ? "outline outline-white/50 outline-3" : ""}
              `} 
              key={index}
